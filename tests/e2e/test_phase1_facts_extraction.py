...
from tests.e2e.helpers import EvidenceValidator, FactsValidator
...
def test_phase1_produces_valid_json(sample_project):
    ...
    facts_data = {
        ...
        "components": [
            {"id": "comp1", "name": "TestClass", "container": "test", "stereotype": "class", "evidence_ids": ["ev_1"]}
        ],
        "interfaces": [],
        "relations": [],
    }

    evidence_data = {"ev_1": {"file_path": "test.java", "start_line": 1, "end_line": 10, "reason": "test"}}
