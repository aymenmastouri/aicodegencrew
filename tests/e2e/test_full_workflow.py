...
from tests.e2e.helpers import FactsValidator, EvidenceValidator, SynthesisValidator
...
def test_workflow_phase1_to_phase2_data_flow(sample_project):
    ...
    if c4_container.exists():
        ...
        assert found_ids >= 1, \
            f"Phase 2 uses Phase 1 container IDs: {found_ids}/{len(container_ids)} found"
