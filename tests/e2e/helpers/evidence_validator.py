        ...
        for evidence_id, evidence in self.evidence_map.items():
            ...
            try:
                ...
                if end_line > total_lines:
                    invalid_ranges.append(f"{evidence_id}: end_line ({end_line}) > total lines ({total_lines})")
                if start_line > end_line:
                    invalid_ranges.append(f"{evidence_id}: start_line ({start_line}) > end_line ({end_line})")
