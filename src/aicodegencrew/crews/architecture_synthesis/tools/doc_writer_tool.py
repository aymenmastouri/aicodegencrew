...
class DocWriterInput(BaseModel):
    ...
    file_path: str = Field(description="The path to the file to write (relative to knowledge/document/)")
...
class DocWriterTool(BaseTool):
    ...
    Writes markdown/text content to files in the knowledge/document directory.
    ...
    description: str = (
        ...
        "Provide the file path (relative to knowledge/document/) and content."
    )
