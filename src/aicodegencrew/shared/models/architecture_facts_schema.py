...
class EvidenceItem(BaseModel):
    ...
    chunk_id: str | None = Field(None, description="ChromaDB chunk ID if indexed")
...
class Relation(BaseModel):
    ...
    id: str | None = Field(None, description="Optional relation ID")
...
class ArchitectureFacts(BaseModel):
    ...
    endpoint_flows: list[EndpointFlow] = Field(
        default_factory=list, description="Endpoint -> Component call chains (for runtime view)"
    )
