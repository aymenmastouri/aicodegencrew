...
- MAX_LLM_OUTPUT_TOKENS: Max output tokens (default: 8000)
...
Default model config: 100K input, 8K output (aligned with .env.example)
"""
...
MAX_LLM_OUTPUT_TOKENS = int(os.getenv("MAX_LLM_OUTPUT_TOKENS", "8000"))
