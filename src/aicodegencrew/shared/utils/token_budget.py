...
- MAX_LLM_INPUT_TOKENS: Total input tokens for LLM (default: 32000)
- MAX_LLM_OUTPUT_TOKENS: Max output tokens (default: 4000)
...
Default model config: 32K input, 4K output
"""

import os

# Read from environment
MAX_LLM_INPUT_TOKENS = int(os.getenv("MAX_LLM_INPUT_TOKENS", "32000"))
MAX_LLM_OUTPUT_TOKENS = int(os.getenv("MAX_LLM_OUTPUT_TOKENS", "4000"))
...
MAX_SNIPPET_LENGTH = 500  # Code snippet per RAG result
