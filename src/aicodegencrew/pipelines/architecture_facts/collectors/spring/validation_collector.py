"""Spring Validation Specialist — Extracts Java/Kotlin Bean Validation facts.
...
class SpringValidationCollector(DimensionCollector):
    """Extracts Bean Validation facts from Java/Kotlin sources."""
