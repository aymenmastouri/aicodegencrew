"""Spring Data Model Specialist — Extracts JPA entity facts.

Detects:
- @Entity annotated classes
- @Table name mappings
- Entity fields with @Id, @Column annotations
...
class SpringDataModelCollector(DimensionCollector):
    """Extracts JPA entity facts from Java files."""
