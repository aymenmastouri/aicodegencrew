...
class SystemCollector(DimensionCollector):
    ...
    def _detect_system_info(self) -> RawSystemInfo:
        ...
        if pom.exists():
            ...
            info.add_evidence(
                ...
                line_start=1,
                line_end=1,
                reason=f"System name from directory: {system_name}"
            )
    ...
    def _extract_context_from_package(self, package_name: str) -> Optional[str]:
        """
        ...
        skip_suffixes = {
            ...
            'controller', 'controllers', 'model', 'models', 
            'entity', 'entities', 'dto', 'dtos', 'config', 
            'configuration', 'util', 'utils', 'common', 'shared',
            'api', 'impl', 'internal', 'test', 'tests'
        }
